...
Podverse-aligned skill. Metaboost also documents depth limits in **unit-tests-confident-granularity** —
use both when scoping tests.
...
- Framework/library behavior tests that do not validate Metaboost logic
