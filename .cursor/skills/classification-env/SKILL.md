...
- **Human docs:** `docs/development/ENV-REFERENCE.md` — Sparse YAML `#` comments are OK for rationale (e.g. host vs in-cluster ports); prefer structured override metadata for home-override topology (`~/.config/metaboost/`).
