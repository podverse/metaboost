...
**Note:** The workspace directory is **`packages/metaboost-signing/`**; the npm package name is **`metaboost-signing`**. Plan text below still describes the original scaffold layout where relevant.
