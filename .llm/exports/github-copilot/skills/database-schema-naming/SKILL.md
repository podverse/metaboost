...
- **linear-db-migrations** (`.llm/exports/github-copilot/skills/linear-db-migrations/SKILL.md`) when changing migration files, ops bundles, or bootstrap under `infra/k8s/base/db/`.
