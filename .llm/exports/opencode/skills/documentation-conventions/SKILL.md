...
- The **only** `INDEX.md` in the repo is `.llm/exports/opencode/skills/INDEX.md` (skills quick reference). All other directory overviews use the full-path name (e.g. `INFRA-K8S.md`, `PACKAGES-UI.md`).
