...
- **Non-empty values**: Double quotes. **Empty/unset**: no value after `=` (see `.llm/exports/opencode/instructions/env-file-formatting.instructions.md`).
...
- [.llm/exports/opencode/instructions/env-file-formatting.instructions.md](../../.llm/exports/opencode/instructions/env-file-formatting.instructions.md)
