...
Plans must be under 300 lines. For file layout (00-EXECUTION-ORDER, COPY-PASTA, etc.), use the **plan-files-convention** skill (`.llm/exports/opencode/skills/plan-files-convention/SKILL.md`).
