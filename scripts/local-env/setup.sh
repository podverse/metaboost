...
DB_MANAGEMENT_OWNER_PASSWORD="$(first_non_empty_or_generate generate_hex_32 "$DB_ENV:DB_MANAGEMENT_OWNER_PASSWORD")"
...
API_AUTH_JWT_SECRET="$(first_non_empty_or_generate generate_hex_32 "$API_INFRA_ENV:AUTH_JWT_SECRET" "$API_APP_ENV:AUTH_JWT_SECRET")"
MANAGEMENT_API_AUTH_JWT_SECRET="$(first_non_empty_or_generate generate_hex_32 "$MANAGEMENT_API_INFRA_ENV:AUTH_JWT_SECRET" "$MANAGEMENT_API_APP_ENV:AUTH_JWT_SECRET")"
...
for f in "$API_APP_ENV" "$API_INFRA_ENV"; do
  upsert_var "$f" "AUTH_JWT_SECRET" "$API_AUTH_JWT_SECRET"
...
for f in "$MANAGEMENT_API_APP_ENV" "$MANAGEMENT_API_INFRA_ENV"; do
  upsert_var "$f" "AUTH_JWT_SECRET" "$MANAGEMENT_API_AUTH_JWT_SECRET"
  upsert_var "$f" "DB_APP_READ_PASSWORD" "$DB_APP_READ_PASSWORD"
  upsert_var "$f" "DB_APP_READ_WRITE_PASSWORD" "$DB_APP_READ_WRITE_PASSWORD"
